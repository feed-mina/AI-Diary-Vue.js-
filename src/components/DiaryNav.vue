     ...
     <div class="nav-wrap">
      ...
      <nav>
        <div class="post-it-nav1">
          ...
          <button class="login-nav" @click="navigateTo('/login')">로그인</button>

          <button class="signup-nav" @click="navigateTo('/signup')">가입하기</button>
        ...
        <div class="post-it-nav2">
          ...
          <button class="diary-nav4" @click="navigateTo('/logout')">로그아웃</button>
      </div>
    </nav>
  </div>
</template>
