          ...
          <form>
            ...
            <div class="tutorial_noDalle">
              ...
              <div class="section2">
                ...
                <div class="tags">
                   <div  v-tooltip="'text1'">>
                    <input type="text" id="tag1" name="tag1" v-model="diaryContent.tags.tag1" placeholder="tag1" disabled/>

                    <input type="text" id="tag2" name="tag2" v-model="diaryContent.tags.tag2" placeholder="tag2" disabled/>

                    <input type="text" id="tag3" name="tag3" v-model="diaryContent.tags.tag3" placeholder="tag3" disabled/>
                   </div>
